...
public class ArbreDAO extends DAO implements IDAO<Arbre> {
    ...
    @Override
    public ArrayList<Arbre> addMany(ArrayList<Arbre> entities) {
    ...
    private Arbre appendDataToArbre(Arbre arbre, Cursor cursor){
        ...
        arbre.setVisiteFloraison(cursor.getInt(24));
        arbre.setVisiteFructification(cursor.getInt(25));
        arbre.setIdProducteur(cursor.getLong(26));
        arbre.setCodeProducteur(cursor.getString(27));
        return arbre;
    }
}
